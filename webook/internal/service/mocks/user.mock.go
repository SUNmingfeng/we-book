...
func (m *MockUserService) FindById(ctx *gin.Context, userid int64) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Signup(ctx *gin.Context, u domain.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserService) UpdateInfo(ctx *gin.Context, user domain.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) UpdateInfo(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateInfo", reflect.TypeOf((*MockUserService)(nil).UpdateInfo), ctx, user)
}
