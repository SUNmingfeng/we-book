...
func (m *MockUserRepository) FindByPhone(ctx *gin.Context, phone string) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateFields(ctx *gin.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateFields", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateFields indicates an expected call of UpdateFields.
func (mr *MockUserRepositoryMockRecorder) UpdateFields(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateFields", reflect.TypeOf((*MockUserRepository)(nil).UpdateFields), ctx, user)
}
